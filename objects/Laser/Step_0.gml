...
if id.laser_cell[0] != target_cell[0] or id.laser_cell[1] != target_cell[1] and instance_exists(target){
	move_to_point = put_in_foreground(laser_cell[0],laser_cell[1]-bullet_offset);
